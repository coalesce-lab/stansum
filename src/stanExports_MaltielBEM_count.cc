...
#include "stanExports_MaltielBEM_count.h"

RCPP_MODULE(stan_fit4MaltielBEM_count_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_MaltielBEM_count")
