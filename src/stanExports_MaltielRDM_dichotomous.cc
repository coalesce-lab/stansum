...
#include "stanExports_MaltielRDM_dichotomous.h"

RCPP_MODULE(stan_fit4MaltielRDM_dichotomous_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_MaltielRDM_dichotomous")
