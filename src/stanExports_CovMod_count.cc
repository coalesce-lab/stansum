...
#include "stanExports_CovMod_count.h"

RCPP_MODULE(stan_fit4CovMod_count_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_CovMod_count")
