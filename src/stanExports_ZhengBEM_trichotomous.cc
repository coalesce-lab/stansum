...
#include "stanExports_ZhengBEM_trichotomous.h"

RCPP_MODULE(stan_fit4ZhengBEM_trichotomous_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_ZhengBEM_trichotomous")
