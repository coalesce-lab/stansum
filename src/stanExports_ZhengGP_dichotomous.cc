...
#include "stanExports_ZhengGP_dichotomous.h"

RCPP_MODULE(stan_fit4ZhengGP_dichotomous_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_ZhengGP_dichotomous")
