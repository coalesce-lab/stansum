...
namespace model_MaltielRDM_count_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_MaltielRDM_count");
    reader.add_event(38, 36, "end", "model_MaltielRDM_count");
    return reader;
}
...
ll_lpdf(const T0__& y,
    ...
    try {
        ...
        return stan::math::promote_scalar<fun_return_scalar_t__>(((binomial_coefficient_log(d, y) + (y * stan::math::log(m))) + ((d - y) * log1m(m))));
...
ll_lpdf(const T0__& y,
            const T1__& m,
            const T2__& d, std::ostream* pstream__) {
    return ll_lpdf<false>(y,m,d, pstream__);
}
struct ll_lpdf_functor__ {
    ...
    operator()(const T0__& y,
        ...
        return ll_lpdf(y, m, d, pstream__);
    }
};
#include <stan_meta_header.hpp>
class model_MaltielRDM_count
  : public stan::model::model_base_crtp<model_MaltielRDM_count> {
private:
        int N;
        int K;
        matrix_d y;
        ...
        vector_d L;
public:
    model_MaltielRDM_count(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_MaltielRDM_count_namespace::model_MaltielRDM_count";
            ...
            for (int i = 1; i <= N; ++i) {
                ...
                for (int k = 1; k <= K; ++k) {
                    ...
                    if (as_bool(logical_gte(get_base1(y, i, k, "y", 1), 0))) {
                        ...
                        lp_accum__.add(ll_lpdf<propto__>(get_base1(y, i, k, "y", 1), get_base1(m, k, "m", 1), get_base1(d, i, "d", 1), pstream__));
                    }
                }
            }
        } catch (const std::exception& e) {
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_MaltielRDM_count_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_MaltielRDM_count_namespace::model_MaltielRDM_count stan_model;
#ifndef USING_R
