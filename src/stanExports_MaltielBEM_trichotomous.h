...
namespace model_MaltielBEM_trichotomous_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_MaltielBEM_trichotomous");
    reader.add_event(45, 43, "end", "model_MaltielBEM_trichotomous");
    return reader;
}
...
ll_b_lpdf(const T0__& m,
    ...
    try {
        ...
        return stan::math::promote_scalar<fun_return_scalar_t__>(((stan::math::log(d) + lbeta(((m * ((1 / rho) - 1)) + 1), ((d + ((1 - m) * ((1 / rho) - 1))) - 1))) - lbeta((m * ((1 / rho) - 1)), ((1 - m) * ((1 / rho) - 1)))));
    } catch (const std::exception& e) {
        stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
        // Next line prevents compiler griping about no return
        throw std::runtime_error("*** IF YOU SEE THIS, PLEASE REPORT A BUG ***");
...
ll_c_lpdf(const T0__& m,
    ...
    try {
        ...
        return stan::math::promote_scalar<fun_return_scalar_t__>(log1m((stan::math::exp((lbeta((m * ((1 / rho) - 1)), (d + ((1 - m) * ((1 / rho) - 1)))) - lbeta((m * ((1 / rho) - 1)), ((1 - m) * ((1 / rho) - 1))))) + stan::math::exp(((stan::math::log(d) + lbeta(((m * ((1 / rho) - 1)) + 1), ((d + ((1 - m) * ((1 / rho) - 1))) - 1))) - lbeta((m * ((1 / rho) - 1)), ((1 - m) * ((1 / rho) - 1))))))));
    } catch (const std::exception& e) {
        stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
        // Next line prevents compiler griping about no return
        throw std::runtime_error("*** IF YOU SEE THIS, PLEASE REPORT A BUG ***");
...
ll_c_lpdf(const T0__& m,
              const T1__& rho,
              const T2__& d, std::ostream* pstream__) {
    return ll_c_lpdf<false>(m,rho,d, pstream__);
}
struct ll_c_lpdf_functor__ {
    template <bool propto, typename T0__, typename T1__, typename T2__>
        typename boost::math::tools::promote_args<T0__, T1__, T2__>::type
    operator()(const T0__& m,
              const T1__& rho,
              const T2__& d, std::ostream* pstream__) const {
        return ll_c_lpdf(m, rho, d, pstream__);
    }
};
#include <stan_meta_header.hpp>
class model_MaltielBEM_trichotomous
  : public stan::model::model_base_crtp<model_MaltielBEM_trichotomous> {
private:
        int K;
        int N;
        matrix_d y;
        vector_d m;
public:
    model_MaltielBEM_trichotomous(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_MaltielBEM_trichotomous_namespace::model_MaltielBEM_trichotomous";
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        try {
            writer__.vector_lb_unconstrain(1, d);
        } catch (const std::exception& e) {
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            if (jacobian__)
                d = in__.vector_lb_constrain(1, N, lp__);
            else
                d = in__.vector_lb_constrain(1, N);
            current_statement_begin__ = 22;
            local_scalar_t__ mu;
            ...
            for (int i = 1; i <= N; ++i) {
                ...
                for (int k = 1; k <= K; ++k) {
                    ...
                    } else if (as_bool(logical_eq(get_base1(y, i, k, "y", 1), 2))) {
                        current_statement_begin__ = 39;
                        lp_accum__.add(ll_c_lpdf(get_base1(m, k, "m", 1), get_base1(rho, k, "rho", 1), get_base1(d, i, "d", 1), pstream__));
                    }
                }
            }
        } catch (const std::exception& e) {
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_MaltielBEM_trichotomous_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        // read-transform, write parameters
        Eigen::Matrix<double, Eigen::Dynamic, 1> d = in__.vector_lb_constrain(1, N);
        size_t d_j_1_max__ = N;
        for (size_t j_1__ = 0; j_1__ < d_j_1_max__; ++j_1__) {
    ...
    std::string model_name() const {
        return "model_MaltielBEM_trichotomous";
    }
...
typedef model_MaltielBEM_trichotomous_namespace::model_MaltielBEM_trichotomous stan_model;
#ifndef USING_R
