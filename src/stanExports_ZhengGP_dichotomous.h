...
namespace model_ZhengGP_dichotomous_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_ZhengGP_dichotomous");
    reader.add_event(37, 35, "end", "model_ZhengGP_dichotomous");
    return reader;
}
...
ll_a_lpdf(const T0__& alpha,
    ...
    try {
        ...
        return stan::math::promote_scalar<fun_return_scalar_t__>(-(stan::math::exp((alpha + beta))));
...
ll_a_lpdf(const T0__& alpha,
              const T1__& beta, std::ostream* pstream__) {
    return ll_a_lpdf<false>(alpha,beta, pstream__);
}
struct ll_a_lpdf_functor__ {
    ...
    operator()(const T0__& alpha,
        ...
        return ll_a_lpdf(alpha, beta, pstream__);
    }
};
template <bool propto, typename T0__, typename T1__>
typename boost::math::tools::promote_args<T0__, T1__>::type
ll_b_lpdf(const T0__& alpha,
    ...
    try {
        ...
        return stan::math::promote_scalar<fun_return_scalar_t__>(log1m(stan::math::exp(-(stan::math::exp((alpha + beta))))));
    } catch (const std::exception& e) {
        stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
        // Next line prevents compiler griping about no return
        throw std::runtime_error("*** IF YOU SEE THIS, PLEASE REPORT A BUG ***");
...
ll_b_lpdf(const T0__& alpha,
              const T1__& beta, std::ostream* pstream__) {
    return ll_b_lpdf<false>(alpha,beta, pstream__);
}
struct ll_b_lpdf_functor__ {
    ...
    operator()(const T0__& alpha,
              const T1__& beta, std::ostream* pstream__) const {
        return ll_b_lpdf(alpha, beta, pstream__);
    }
};
#include <stan_meta_header.hpp>
class model_ZhengGP_dichotomous
  : public stan::model::model_base_crtp<model_ZhengGP_dichotomous> {
private:
        int N;
        int K;
        std::vector<std::vector<int> > y;
public:
    model_ZhengGP_dichotomous(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_ZhengGP_dichotomous_namespace::model_ZhengGP_dichotomous";
            ...
            for (int i = 1; i <= N; ++i) {
                ...
                for (int k = 1; k <= K; ++k) {
                    ...
                    if (as_bool(logical_eq(get_base1(get_base1(y, i, "y", 1), k, "y", 2), 0))) {
                        ...
                        lp_accum__.add(ll_a_lpdf(get_base1(alpha, i, "alpha", 1), get_base1(beta, k, "beta", 1), pstream__));
                    } else if (as_bool(logical_eq(get_base1(get_base1(y, i, "y", 1), k, "y", 2), 1))) {
                        current_statement_begin__ = 31;
                        lp_accum__.add(ll_b_lpdf(get_base1(alpha, i, "alpha", 1), get_base1(beta, k, "beta", 1), pstream__));
                    }
                }
            }
        } catch (const std::exception& e) {
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_ZhengGP_dichotomous_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
    ...
    std::string model_name() const {
        return "model_ZhengGP_dichotomous";
    }
...
typedef model_ZhengGP_dichotomous_namespace::model_ZhengGP_dichotomous stan_model;
#ifndef USING_R
