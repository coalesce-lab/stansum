...
namespace model_MaltielRDM_dichotomous_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_MaltielRDM_dichotomous");
    reader.add_event(38, 36, "end", "model_MaltielRDM_dichotomous");
    return reader;
}
template <bool propto, typename T0__, typename T1__>
typename boost::math::tools::promote_args<T0__, T1__>::type
ll_a_lpdf(const T0__& m,
              const T1__& d, std::ostream* pstream__) {
    ...
    try {
        ...
        return stan::math::promote_scalar<fun_return_scalar_t__>((d * log1m(m)));
...
ll_a_lpdf(const T0__& m,
              const T1__& d, std::ostream* pstream__) {
    return ll_a_lpdf<false>(m,d, pstream__);
}
struct ll_a_lpdf_functor__ {
    template <bool propto, typename T0__, typename T1__>
        typename boost::math::tools::promote_args<T0__, T1__>::type
    operator()(const T0__& m,
              const T1__& d, std::ostream* pstream__) const {
        return ll_a_lpdf(m, d, pstream__);
    }
};
template <bool propto, typename T0__, typename T1__>
typename boost::math::tools::promote_args<T0__, T1__>::type
ll_b_lpdf(const T0__& m,
    ...
    try {
        ...
        return stan::math::promote_scalar<fun_return_scalar_t__>(log1m(pow((1 - m), d)));
    } catch (const std::exception& e) {
        stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
        // Next line prevents compiler griping about no return
        throw std::runtime_error("*** IF YOU SEE THIS, PLEASE REPORT A BUG ***");
...
ll_b_lpdf(const T0__& m,
              const T1__& d, std::ostream* pstream__) {
    return ll_b_lpdf<false>(m,d, pstream__);
}
struct ll_b_lpdf_functor__ {
    ...
    operator()(const T0__& m,
              const T1__& d, std::ostream* pstream__) const {
        return ll_b_lpdf(m, d, pstream__);
    }
};
#include <stan_meta_header.hpp>
class model_MaltielRDM_dichotomous
  : public stan::model::model_base_crtp<model_MaltielRDM_dichotomous> {
private:
        int N;
        int K;
        matrix_d y;
        vector_d m;
public:
    model_MaltielRDM_dichotomous(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_MaltielRDM_dichotomous_namespace::model_MaltielRDM_dichotomous";
            ...
            for (int i = 1; i <= N; ++i) {
                ...
                for (int k = 1; k <= K; ++k) {
                    ...
                    if (as_bool(logical_eq(get_base1(y, i, k, "y", 1), 0))) {
                        ...
                        lp_accum__.add(ll_a_lpdf(get_base1(m, k, "m", 1), get_base1(d, i, "d", 1), pstream__));
                    } else if (as_bool(logical_eq(get_base1(y, i, k, "y", 1), 1))) {
                        current_statement_begin__ = 32;
                        lp_accum__.add(ll_b_lpdf(get_base1(m, k, "m", 1), get_base1(d, i, "d", 1), pstream__));
                    }
                }
            }
        } catch (const std::exception& e) {
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_MaltielRDM_dichotomous_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
    ...
    std::string model_name() const {
        return "model_MaltielRDM_dichotomous";
    }
...
typedef model_MaltielRDM_dichotomous_namespace::model_MaltielRDM_dichotomous stan_model;
#ifndef USING_R
