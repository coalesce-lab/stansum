...
namespace model_ZhengBEM_trichotomous_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_ZhengBEM_trichotomous");
    reader.add_event(48, 46, "end", "model_ZhengBEM_trichotomous");
    return reader;
}
template <bool propto, typename T0__, typename T1__>
typename boost::math::tools::promote_args<T0__, T1__>::type
ll_a_lpdf(const T0__& xi,
              const T1__& inv_omega, std::ostream* pstream__) {
    ...
    try {
        ...
        return stan::math::promote_scalar<fun_return_scalar_t__>((xi * stan::math::log(inv_omega)));
...
ll_a_lpdf(const T0__& xi,
              const T1__& inv_omega, std::ostream* pstream__) {
    return ll_a_lpdf<false>(xi,inv_omega, pstream__);
}
struct ll_a_lpdf_functor__ {
    template <bool propto, typename T0__, typename T1__>
        typename boost::math::tools::promote_args<T0__, T1__>::type
    operator()(const T0__& xi,
              const T1__& inv_omega, std::ostream* pstream__) const {
        return ll_a_lpdf(xi, inv_omega, pstream__);
    }
};
template <bool propto, typename T0__, typename T1__>
typename boost::math::tools::promote_args<T0__, T1__>::type
ll_b_lpdf(const T0__& xi,
              const T1__& inv_omega, std::ostream* pstream__) {
    typedef typename boost::math::tools::promote_args<T0__, T1__>::type local_scalar_t__;
    typedef local_scalar_t__ fun_return_scalar_t__;
    const static bool propto__ = true;
    ...
    try {
        ...
        return stan::math::promote_scalar<fun_return_scalar_t__>(((stan::math::log(xi) + (xi * stan::math::log(inv_omega))) + log1m(inv_omega)));
    } catch (const std::exception& e) {
        stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
        // Next line prevents compiler griping about no return
        throw std::runtime_error("*** IF YOU SEE THIS, PLEASE REPORT A BUG ***");
...
ll_b_lpdf(const T0__& xi,
              const T1__& inv_omega, std::ostream* pstream__) {
    return ll_b_lpdf<false>(xi,inv_omega, pstream__);
}
struct ll_b_lpdf_functor__ {
    ...
    operator()(const T0__& xi,
              const T1__& inv_omega, std::ostream* pstream__) const {
        return ll_b_lpdf(xi, inv_omega, pstream__);
    }
};
template <bool propto, typename T0__, typename T1__>
typename boost::math::tools::promote_args<T0__, T1__>::type
ll_c_lpdf(const T0__& xi,
              const T1__& inv_omega, std::ostream* pstream__) {
    typedef typename boost::math::tools::promote_args<T0__, T1__>::type local_scalar_t__;
    typedef local_scalar_t__ fun_return_scalar_t__;
    const static bool propto__ = true;
    ...
    try {
        ...
        return stan::math::promote_scalar<fun_return_scalar_t__>(log1m((stan::math::exp((xi * stan::math::log(inv_omega))) + stan::math::exp(((stan::math::log(xi) + (xi * stan::math::log(inv_omega))) + log1m(inv_omega))))));
    } catch (const std::exception& e) {
        stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
        // Next line prevents compiler griping about no return
        throw std::runtime_error("*** IF YOU SEE THIS, PLEASE REPORT A BUG ***");
...
ll_c_lpdf(const T0__& xi,
              const T1__& inv_omega, std::ostream* pstream__) {
    return ll_c_lpdf<false>(xi,inv_omega, pstream__);
}
struct ll_c_lpdf_functor__ {
    ...
    operator()(const T0__& xi,
              const T1__& inv_omega, std::ostream* pstream__) const {
        return ll_c_lpdf(xi, inv_omega, pstream__);
    }
};
#include <stan_meta_header.hpp>
class model_ZhengBEM_trichotomous
  : public stan::model::model_base_crtp<model_ZhengBEM_trichotomous> {
private:
        int N;
        int K;
        std::vector<std::vector<int> > y;
public:
    model_ZhengBEM_trichotomous(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_ZhengBEM_trichotomous_namespace::model_ZhengBEM_trichotomous";
        ...
        try {
            ...
            for (int k = 1; k <= K; ++k) {
                ...
                for (int i = 1; i <= N; ++i) {
                    ...
                    if (as_bool(logical_eq(get_base1(get_base1(y, i, "y", 1), k, "y", 2), 0))) {
                        current_statement_begin__ = 38;
                        lp_accum__.add(ll_a_lpdf(xi_i_k, get_base1(inv_omega, k, "inv_omega", 1), pstream__));
                    } else if (as_bool(logical_eq(get_base1(get_base1(y, i, "y", 1), k, "y", 2), 1))) {
                        current_statement_begin__ = 40;
                        lp_accum__.add(ll_b_lpdf(xi_i_k, get_base1(inv_omega, k, "inv_omega", 1), pstream__));
                    } else if (as_bool(logical_eq(get_base1(get_base1(y, i, "y", 1), k, "y", 2), 2))) {
                        current_statement_begin__ = 42;
                        lp_accum__.add(ll_c_lpdf(xi_i_k, get_base1(inv_omega, k, "inv_omega", 1), pstream__));
                    }
                    }
                }
                }
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_ZhengBEM_trichotomous_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
    ...
    std::string model_name() const {
        return "model_ZhengBEM_trichotomous";
    }
...
typedef model_ZhengBEM_trichotomous_namespace::model_ZhengBEM_trichotomous stan_model;
#ifndef USING_R
