...
namespace model_ZhengBEM_dichotomous_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_ZhengBEM_dichotomous");
    reader.add_event(43, 41, "end", "model_ZhengBEM_dichotomous");
    return reader;
}
...
ll_b_lpdf(const T0__& xi,
    ...
    try {
        ...
        return stan::math::promote_scalar<fun_return_scalar_t__>(log1m(pow(inv_omega, xi)));
    } catch (const std::exception& e) {
        stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
        // Next line prevents compiler griping about no return
        throw std::runtime_error("*** IF YOU SEE THIS, PLEASE REPORT A BUG ***");
...
class model_ZhengBEM_dichotomous
  : public stan::model::model_base_crtp<model_ZhengBEM_dichotomous> {
private:
        int N;
        int K;
        std::vector<std::vector<int> > y;
public:
    model_ZhengBEM_dichotomous(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_ZhengBEM_dichotomous_namespace::model_ZhengBEM_dichotomous";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_ZhengBEM_dichotomous_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
    ...
    std::string model_name() const {
        return "model_ZhengBEM_dichotomous";
    }
...
typedef model_ZhengBEM_dichotomous_namespace::model_ZhengBEM_dichotomous stan_model;
#ifndef USING_R
