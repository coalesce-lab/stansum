...
#include "stanExports_MaltielRDM_count.h"

RCPP_MODULE(stan_fit4MaltielRDM_count_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_MaltielRDM_count")
