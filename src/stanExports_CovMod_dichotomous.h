...
namespace model_CovMod_dichotomous_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_CovMod_dichotomous");
    reader.add_event(47, 45, "end", "model_CovMod_dichotomous");
    return reader;
}
...
ll_a_lpdf(const T0__& alpha,
              const T1__& beta,
              const T2__& gamma_age,
              const T3__& gamma_sex,
              const T4__& age,
              const T5__& male, std::ostream* pstream__) {
    ...
    try {
        ...
        return stan::math::promote_scalar<fun_return_scalar_t__>(-(stan::math::exp((((alpha + beta) + (gamma_age * age)) + (gamma_sex * male)))));
...
ll_a_lpdf(const T0__& alpha,
              ...
              const T4__& age,
              const T5__& male, std::ostream* pstream__) {
    return ll_a_lpdf<false>(alpha,beta,gamma_age,gamma_sex,age,male, pstream__);
}
struct ll_a_lpdf_functor__ {
    ...
    operator()(const T0__& alpha,
              ...
              const T3__& gamma_sex,
              const T4__& age,
              const T5__& male, std::ostream* pstream__) const {
        return ll_a_lpdf(alpha, beta, gamma_age, gamma_sex, age, male, pstream__);
    }
};
template <bool propto, typename T0__, typename T1__, typename T2__, typename T3__, typename T4__, typename T5__>
typename boost::math::tools::promote_args<T0__, T1__, T2__, T3__, typename boost::math::tools::promote_args<T4__, T5__>::type>::type
ll_b_lpdf(const T0__& alpha,
              const T1__& beta,
              const T2__& gamma_age,
              const T3__& gamma_sex,
              const T4__& age,
    ...
    try {
        ...
        return stan::math::promote_scalar<fun_return_scalar_t__>(log1m(stan::math::exp(-(stan::math::exp((((alpha + beta) + (gamma_age * age)) + (gamma_sex * male)))))));
    } catch (const std::exception& e) {
        stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
        // Next line prevents compiler griping about no return
        throw std::runtime_error("*** IF YOU SEE THIS, PLEASE REPORT A BUG ***");
...
ll_b_lpdf(const T0__& alpha,
              ...
              const T4__& age,
              const T5__& male, std::ostream* pstream__) {
    return ll_b_lpdf<false>(alpha,beta,gamma_age,gamma_sex,age,male, pstream__);
}
struct ll_b_lpdf_functor__ {
    ...
    operator()(const T0__& alpha,
              ...
              const T4__& age,
              const T5__& male, std::ostream* pstream__) const {
        return ll_b_lpdf(alpha, beta, gamma_age, gamma_sex, age, male, pstream__);
    }
};
#include <stan_meta_header.hpp>
class model_CovMod_dichotomous
  : public stan::model::model_base_crtp<model_CovMod_dichotomous> {
private:
        int N;
        int K;
        matrix_d y;
        ...
        vector_d male;
public:
    model_CovMod_dichotomous(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_CovMod_dichotomous_namespace::model_CovMod_dichotomous";
        ...
        try {
            ...
            context__.validate_dims("data initialization", "male", "vector_d", context__.to_vec(N));
            male = Eigen::Matrix<double, Eigen::Dynamic, 1>(N);
            vals_r__ = context__.vals_r("male");
            pos__ = 0;
            size_t male_j_1_max__ = N;
            for (size_t j_1__ = 0; j_1__ < male_j_1_max__; ++j_1__) {
                male(j_1__) = vals_r__[pos__++];
            }
            ...
            validate_non_negative_index("gamma_age", "K", K);
            num_params_r__ += K;
            current_statement_begin__ = 25;
            validate_non_negative_index("gamma_sex", "K", K);
            num_params_r__ += K;
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        current_statement_begin__ = 24;
        if (!(context__.contains_r("gamma_age")))
            stan::lang::rethrow_located(std::runtime_error(std::string("Variable gamma_age missing")), current_statement_begin__, prog_reader__());
        vals_r__ = context__.vals_r("gamma_age");
        pos__ = 0U;
        validate_non_negative_index("gamma_age", "K", K);
        context__.validate_dims("parameter initialization", "gamma_age", "vector_d", context__.to_vec(K));
        Eigen::Matrix<double, Eigen::Dynamic, 1> gamma_age(K);
        size_t gamma_age_j_1_max__ = K;
        for (size_t j_1__ = 0; j_1__ < gamma_age_j_1_max__; ++j_1__) {
            gamma_age(j_1__) = vals_r__[pos__++];
        }
        try {
            writer__.vector_unconstrain(gamma_age);
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(std::runtime_error(std::string("Error transforming variable gamma_age: ") + e.what()), current_statement_begin__, prog_reader__());
        }
        current_statement_begin__ = 25;
        if (!(context__.contains_r("gamma_sex")))
            stan::lang::rethrow_located(std::runtime_error(std::string("Variable gamma_sex missing")), current_statement_begin__, prog_reader__());
        vals_r__ = context__.vals_r("gamma_sex");
        pos__ = 0U;
        validate_non_negative_index("gamma_sex", "K", K);
        context__.validate_dims("parameter initialization", "gamma_sex", "vector_d", context__.to_vec(K));
        Eigen::Matrix<double, Eigen::Dynamic, 1> gamma_sex(K);
        size_t gamma_sex_j_1_max__ = K;
        for (size_t j_1__ = 0; j_1__ < gamma_sex_j_1_max__; ++j_1__) {
            gamma_sex(j_1__) = vals_r__[pos__++];
        }
        try {
            writer__.vector_unconstrain(gamma_sex);
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(std::runtime_error(std::string("Error transforming variable gamma_sex: ") + e.what()), current_statement_begin__, prog_reader__());
        }
        current_statement_begin__ = 26;
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            current_statement_begin__ = 24;
            Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> gamma_age;
            (void) gamma_age;  // dummy to suppress unused var warning
            if (jacobian__)
                gamma_age = in__.vector_constrain(K, lp__);
            else
                gamma_age = in__.vector_constrain(K);
            current_statement_begin__ = 25;
            Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> gamma_sex;
            (void) gamma_sex;  // dummy to suppress unused var warning
            if (jacobian__)
                gamma_sex = in__.vector_constrain(K, lp__);
            else
                gamma_sex = in__.vector_constrain(K);
            current_statement_begin__ = 26;
            ...
            lp_accum__.add(normal_log<propto__>(gamma_age, 0, sigma_gamma));
            current_statement_begin__ = 34;
            lp_accum__.add(normal_log<propto__>(gamma_sex, 0, sigma_gamma));
            current_statement_begin__ = 35;
            lp_accum__.add(gamma_log<propto__>(sigma_gamma, 1, 0.01));
            ...
            for (int i = 1; i <= N; ++i) {
                ...
                for (int k = 1; k <= K; ++k) {
                    ...
                    if (as_bool(logical_eq(get_base1(y, i, k, "y", 1), 0))) {
                        ...
                        lp_accum__.add(ll_a_lpdf(get_base1(alpha, i, "alpha", 1), get_base1(beta, k, "beta", 1), get_base1(gamma_age, k, "gamma_age", 1), get_base1(gamma_sex, k, "gamma_sex", 1), get_base1(age, i, "age", 1), get_base1(male, i, "male", 1), pstream__));
                    } else if (as_bool(logical_eq(get_base1(y, i, k, "y", 1), 1))) {
                        current_statement_begin__ = 41;
                        lp_accum__.add(ll_b_lpdf(get_base1(alpha, i, "alpha", 1), get_base1(beta, k, "beta", 1), get_base1(gamma_age, k, "gamma_age", 1), get_base1(gamma_sex, k, "gamma_sex", 1), get_base1(age, i, "age", 1), get_base1(male, i, "male", 1), pstream__));
                    }
                }
            }
        } catch (const std::exception& e) {
    ...
    void get_param_names(std::vector<std::string>& names__) const {
        ...
        names__.push_back("gamma_age");
        names__.push_back("gamma_sex");
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_CovMod_dichotomous_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        Eigen::Matrix<double, Eigen::Dynamic, 1> gamma_age = in__.vector_constrain(K);
        size_t gamma_age_j_1_max__ = K;
        for (size_t j_1__ = 0; j_1__ < gamma_age_j_1_max__; ++j_1__) {
            vars__.push_back(gamma_age(j_1__));
        }
        Eigen::Matrix<double, Eigen::Dynamic, 1> gamma_sex = in__.vector_constrain(K);
        size_t gamma_sex_j_1_max__ = K;
        for (size_t j_1__ = 0; j_1__ < gamma_sex_j_1_max__; ++j_1__) {
            vars__.push_back(gamma_sex(j_1__));
        }
    ...
    std::string model_name() const {
        return "model_CovMod_dichotomous";
    }
    void constrained_param_names(std::vector<std::string>& param_names__,
        ...
        for (size_t j_1__ = 0; j_1__ < gamma_age_j_1_max__; ++j_1__) {
            param_name_stream__.str(std::string());
            param_name_stream__ << "gamma_age" << '.' << j_1__ + 1;
            param_names__.push_back(param_name_stream__.str());
        }
        size_t gamma_sex_j_1_max__ = K;
        for (size_t j_1__ = 0; j_1__ < gamma_sex_j_1_max__; ++j_1__) {
            param_name_stream__.str(std::string());
            param_name_stream__ << "gamma_sex" << '.' << j_1__ + 1;
            param_names__.push_back(param_name_stream__.str());
        }
        param_name_stream__.str(std::string());
...
typedef model_CovMod_dichotomous_namespace::model_CovMod_dichotomous stan_model;
#ifndef USING_R
