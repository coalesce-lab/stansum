...
namespace model_CovMod_count_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_CovMod_count");
    reader.add_event(36, 34, "end", "model_CovMod_count");
    return reader;
}
#include <stan_meta_header.hpp>
class model_CovMod_count
  : public stan::model::model_base_crtp<model_CovMod_count> {
private:
        int N;
        int K;
        ...
        vector_d male;
public:
    model_CovMod_count(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_CovMod_count_namespace::model_CovMod_count";
            ...
            for (int i = 1; i <= N; ++i) {
                ...
                for (int k = 1; k <= K; ++k) {
                    ...
                    if (as_bool(logical_gte(get_base1(get_base1(y, i, "y", 1), k, "y", 2), 0))) {
                        ...
                        stan::math::assign(rate,stan::math::exp((((get_base1(alpha, i, "alpha", 1) + get_base1(beta, k, "beta", 1)) + (get_base1(gamma_age, k, "gamma_age", 1) * get_base1(age, i, "age", 1))) + (get_base1(gamma_sex, k, "gamma_sex", 1) * get_base1(male, i, "male", 1)))));
                        current_statement_begin__ = 30;
                        lp_accum__.add(poisson_log<propto__>(get_base1(get_base1(y, i, "y", 1), k, "y", 2), rate));
                        }
                    }
                }
            }
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_CovMod_count_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_CovMod_count_namespace::model_CovMod_count stan_model;
#ifndef USING_R
